...
var wholeSection = '<div id="event-main"> <div id="upcoming-events"> <h2>UPCOMING EVENTS</h2> </div>';
...
wholeSection += 
        '<div class="text-center mt-3">' +
            '<div class="row justify-content-md-center mx-auto btn-group"> <a href="#" class="col page-nav page-nav-text">Previous</a>' +
                '<a href="#" class="col page-nav page-nav-text">0</a> <a href="#" class="col page-nav page-nav-text">1</a>' +
                '<a href="#" class="col page-nav page-nav-text">2</a> <a href="#" class="col page-nav page-nav-text">3</a>' + 
                '<a href="#" class="col page-nav page-nav-text">4</a> <a href="#" class="col page-nav page-nav-text">Next</a></div> </div> </div>';
