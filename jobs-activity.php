            ...
            <div class="container h5">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="upcoming_events.html"><b>Events</b></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <div class="dropdown nav-prof-bar">
                                ...
                                <div id="myDropdown" class="dropdown-content">
                                    ...
                                    <hr class="no-margin">
                                    <a class="index-chosen-dropdown" href="jobs-activity.html">Job Activity</a>
                    ...
                    <div id="act-main" class="card mb-3">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div id="act-box" class="row">
                                    <div class="col-md-4">
                                        <a href="jobs-details1.html"><img src="img/Dell.png" class="act-image"></a>
                                        <a href="jobs-details1.html" id="no-blue"><h6 id="act-jobname">
